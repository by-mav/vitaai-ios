...
private let allFeatures: [PaywallFeature] = [
    ...
    .init(id: "faculdades",
          ...
          minTier: .free,
          detail: "Conecte o Canvas e tenha agenda, tarefas e materiais automaticamente sincronizados.",
          highlights: ["Sync automático do Canvas", "Agenda e tarefas sempre atualizadas", "Materiais do curso no app", "Leitura IA dos planos de ensino", "Base preparada para Moodle parceiro"]),
    .init(id: "notas",
