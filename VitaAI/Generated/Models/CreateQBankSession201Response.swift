//
// CreateQBankSession201Response.swift
//
...
public struct CreateQBankSession201Response: Sendable, Codable, Hashable {
    ...
    public var officialExam: CreateQBankSession201ResponseAllOfOfficialExam?
    public var catalogBlock: CreateQBankSession201ResponseAllOfCatalogBlock?

    public init(id: String? = nil, title: String? = nil, questionCount: Int? = nil, totalQuestions: Int? = nil, currentIndex: Int? = nil, answeredCount: Int? = nil, answeredQuestions: Int? = nil, correctCount: Int? = nil, correctAnswers: Int? = nil, score: Double? = nil, createdAt: Date? = nil, finishedAt: Date? = nil, disciplineTitle: String? = nil, topicTitle: String? = nil, disciplineTitles: [String]? = nil, questionIds: [Int]? = nil, officialExam: CreateQBankSession201ResponseAllOfOfficialExam? = nil, catalogBlock: CreateQBankSession201ResponseAllOfCatalogBlock? = nil) {
        self.id = id
        self.title = title
        ...
        self.officialExam = officialExam
        self.catalogBlock = catalogBlock
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(officialExam, forKey: .officialExam)
        try container.encodeIfPresent(catalogBlock, forKey: .catalogBlock)
    }
}


extension CreateQBankSession201Response: Identifiable {}
