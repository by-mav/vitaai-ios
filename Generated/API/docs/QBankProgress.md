...
**byArea** | [QBankProgressByAreaInner] | Desempenho pelas GRANDES ÁREAS DE PROVA (exam_great_areas, CNRM/ENARE: Ciclo Básico, Clínica Médica, Cirurgia Geral, GO, Pediatria, Medicina Preventiva) → disciplinas canônicas (via qbank_topics.disciplineSlug → disciplines.examGreatAreaSlug). Cada área traz accuracy média + as disciplinas, ordenadas mais fracas primeiro. Added 2026-07-16.  | [optional] 
